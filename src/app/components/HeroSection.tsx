      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            >
              <span className="text-white">Votre santé,</span>
              <br />
              <span className="gradient-text-hero">connectée</span>
              <br />
              <span className="text-white">et protégée</span>
            </h1>

            {/* Subtitle */}
            <p className="text-lg sm:text-xl text-slate-400 max-w-lg mx-auto lg:mx-0 leading-relaxed animate-slide-up animate-delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-slide-up animate-delay-300">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-medium text-slate-300 border border-slate-700 rounded-2xl hover:bg-white/5 hover:border-slate-500 hover:text-white transition-all duration-300"
              >
